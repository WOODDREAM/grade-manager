                        ...
                        <form class="cmxform form-horizontal tasi-form">
                            <section class="panel">
                                <div class="form-group ">
                                    <label for="classCreateName" class="control-label col-lg-2">名称</label>

                                    <div class="col-lg-10">
                                        <input class=" form-control" id="classCreateName" name="className" type="text"
                                               autofocus/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    <label for="classCreateCredit" class="control-label col-lg-2">学分</label>

                                    <div class="col-lg-10">
                                        <input class="form-control " id="classCreateCredit" name="classCredit"
                                               type="text"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="classCreateUnit" class="control-label col-lg-2">上课单位(周)</label>

                                    <div class="col-lg-10">
                                        <input class="form-control " id="classCreateUnit" name="classUnit" type="text"
                                               value="周" readonly>
                                    </div>
                                </div>
                                <div class="form-group ">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-lg-offset-1 col-lg-10">
                    <button class="btn btn-danger btn-lg" type="button" id="btn-class-create">确定</button>
                </div>
            </div>
        </div>
    </div>
